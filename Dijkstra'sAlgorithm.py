...
if __name__ == "__main__":
    nodes = ['Reykjavik', 'Oslo', 'Paris', 'London', 'Berlin', 'Potosi', 'Athens','Dublin']
    ...
    init_graph['Oslo']['Paris'] = 3
    init_graph['Paris']['Potosi'] = 5
    init_graph['Paris']['Athens'] = 4
    init_graph['Athens']['Potosi'] = 1
    init_graph['Dublin']['Berlin'] = 2
    init_graph['Dublin']['Athens'] = 2
